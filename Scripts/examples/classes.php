...
class Employee {
	...
	private function privateMethod() {
		echo get_class() . ' >> private method' . PHP_EOL;
	}
	...
	protected function protectedMethod() {
		echo get_class() . ' >> protected method' . PHP_EOL;
	}

	final function finalMethod() {
		echo get_class() . ' >> final method' . PHP_EOL;
	}
...
class Manager extends Employee {
	...
	// This will cause error: Cannot override final method Employee::finalMethod()
