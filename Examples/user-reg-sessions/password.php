...
<form action="password.php" method="post">
	<p><input type="text" name="email" size="20" maxlength="60"
      value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>"
      placeholder="Email Address">
   </p>
	<p><input type="password" name="pass" size="20" maxlength="60"
      value="<?php if (isset($_POST['pass'])) echo $_POST['pass']; ?>"
      placeholder="Password">
  </p>
	<p><input type="password" name="pass1" size="20" maxlength="60"
      value="<?php if (isset($_POST['pass1'])) echo $_POST['pass1']; ?>"
      placeholder="Password">
  </p>
	<p><input type="password" name="pass2" size="20" maxlength="60"
