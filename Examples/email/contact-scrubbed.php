...
<body>
<h1>Contact Me</h1>
<?php # contact-scrubbed.php
// This version scrubs unwanted strings from the submitted input.
// This cuts down on possible spamming
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	*/
	function spam_scrubber($value) {
		...
		$very_bad =
      array('to:', 'cc:', 'bcc:', 'content-type:', 'mime-version:',
...
<form action="email.php" method="post">
	<p>Name: <input type="text" name="name" size="30" maxlength="60"
     value="<?php if (isset($scrubbed['name'])) echo $scrubbed['name']; ?>">
  </p>
	<p>Email Address: <input type="text" name="email" size="30" maxlength="80"
     value="<?php if (isset($scrubbed['email'])) echo $scrubbed['email']; ?>">
  </p>
