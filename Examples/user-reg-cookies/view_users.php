<?php # Script 10.5-1
// Same as script 10.5 but uses functions for sort and pagination
...
// Define the query:
// First time it's run $start = 0, $display = 10
...
$res = mysqli_query ($dbc, $query); // Run the query.

$num = mysqli_num_rows($res);

if ($num > 0) {
  // Table header:
  echo '<br><table align="center" cellspacing="0" cellpadding="5" width="75%">
<tr>
