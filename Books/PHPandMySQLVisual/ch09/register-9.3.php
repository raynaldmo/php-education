...
// Copied from script_09_03/register.php and put into this directory
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (empty($errors)) { // If everything's OK.
    ...
    // Make the query:
    $q = "INSERT INTO
           users (first_name, last_name, email, pass, registration_date)
    ...
    // Terminate script here - otherwise registration form would be
    // shown again.
    exit();
...
?>
  <h1>Register</h1>
  <form action="register-9.3.php" method="post">
    ...
    <p><input type="password" name="pass2" placeholder="Confirm Password"
          size="20" maxlength="60"
